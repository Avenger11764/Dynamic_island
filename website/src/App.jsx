      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-white/10 rounded-none bg-[#030712]/50 backdrop-blur-2xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="https://raw.githubusercontent.com/Avenger11764/Dynamic_island/main/Installers/App_Installer.zip" className="bg-white text-black px-5 py-2.5 rounded-full font-medium text-sm hover:bg-gray-100 transition-all active:scale-95 flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="https://raw.githubusercontent.com/Avenger11764/Dynamic_island/main/Installers/App_Installer.zip" className="bg-white text-black px-8 py-4 rounded-full font-semibold text-base hover:bg-gray-100 transition-all shadow-[0_0_40px_rgba(255,255,255,0.2)] active:scale-95 flex items-center gap-2">
              ...
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Grab the latest compiled `App_Installer.zip` release from our GitHub.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="text-white font-semibold text-lg mb-1">Extract & Run</h4>
                    <p className="text-gray-400 text-sm">Unzip the archive and double-click `Dynamic Island Setup.exe`.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
